...
export function SettingsTab() {
  ...
  const handleSaveAndExit = async () => {
    ...
    // 2. Give the browser 1 second to process the download before killing the server
    setTimeout(async () => {
      try {
    ...
    <div className="w-full h-full flex flex-col relative select-none">
      ...
      {loading ? (
        ...
        <div className="flex-1 flex flex-col gap-8 overflow-y-auto max-h-[calc(100vh-220px)] pr-2 pb-8">
          ...
          <div className="bg-gradient-to-br from-neutral-950/40 to-neutral-900/10 border border-white/5 rounded-[28px] p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-3">
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <Save className="w-4 h-4" /> Save Data & Exit
                </button>

                {/* Exit Without Saving */}
                <button
                  onClick={handleExitDirect}
                  className="w-full py-4 rounded-[20px] bg-white/5 border border-white/5 hover:bg-white/10 text-white font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2"
                >
                  🚪 Exit Without Saving
                </button>
